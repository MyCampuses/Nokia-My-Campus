...
let strings = new LocalizedStrings({
    ...
    se:{
        ...
        welcome: "Välkommen till progressiva web application som erbjudar information av de tre mäst populära områden på Nokia HQ, Espoo",
        logoAlt: "MyCampus Logo",
        ...
        roofTopElectricPlaces: "Tak elektriska platser (est.)",
        p10MapAlt: "P10 Karta",
        p5MapAlt:"P5 Karta",
        map: "Karta",
